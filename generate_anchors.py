...
if "__main__" == __name__:
    ...
    parser.add_argument('--num_clusters', '-n', default=3, type=int, help='Number of Clusters')
    parser.add_argument('--output', '-o', default='./anchors/anchor.txt', type=str, help='Result Output File')
