...
{
    char *train_images = "/home/lincs/Diogo/yolo/darknet/data/train.txt";
    char *backup_directory = "/home/lincs/Diogo/yolo/darknet/backup/";
    srand(time(0));
...
void validate_yolo(char *cfg, char *weights)
{
    ...
    list *plist = get_paths("/home/lincs/Diogo/yolo/darknet/data/test.txt");
